...
--
-- Host: 127.0.0.1:3306
-- Generation Time: 2020-11-10 21:31:35
-- 服务器版本： 5.6.48-log
-- PHP Version: 7.1.32
...
(48, 'email_account', '', '邮箱账号', 0, 0, 0, 1598539052),
(49, 'email_password', '', '邮箱密码', 0, 0, 0, 1598539052);
...
--
ALTER TABLE `sa_conf`
  MODIFY `conf_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=50;
--
